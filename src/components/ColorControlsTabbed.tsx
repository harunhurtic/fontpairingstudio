...
export function ColorControlsTabbed(props: ColorControlsProps) {
  const {
    textColor,
    backgroundColor,
    buttonBgColor,
  ...
  if (buttonVariant === "filled") {
    ...
    buttonTextContrastResult = checkContrast(
      buttonTextColor,
      buttonBgColor,
    );
    buttonOutlineOrBgContrastResult = checkContrast(
      buttonBgColor,
      backgroundColor,
    );
  ...
  return (
    <Tabs defaultValue="colors" className="w-full">
      ...
      {/* Tab 1: Colors - Color pickers and presets */}
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button
                    ...
                    title={
                      buttonVariant === "ghost"
                        ? "Disabled for ghost buttons"
                        : buttonVariant === "outline"
                          ? "Pick button outline color"
                          : "Pick button background color"
                    }
      ...
      {/* Tab 2: Accessibility - WCAG Contrast Checker */}
      <TabsContent
        value="accessibility"
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Ensures your text and background colors are readable
          for all users, including those with visual
          impairments.
        </p>

        {/* WCAG 2.1 Standards */}
        <div className="text-sm font-medium mb-2">WCAG 2.1</div>
        ...
        <div className="space-y-2 pb-3 border-b">
          <h4 className="text-sm font-medium">Normal Text</h4>
